...
echo "Create ABC ESD DIR"
rm -rf $TCP_SERVER_BRIDGE_CFG_ESD_DIR
mkdir $TCP_SERVER_BRIDGE_CFG_ESD_DIR
chown -R $TCP_SERVER_BRIDGE_USER:$TCP_SERVER_BRIDGE_USER $TCP_SERVER_BRIDGE_CFG_ESD_DIR
